...
RUN  cd / && pip3 install openlineage-airflow plyvel certifi Lyftrondata* pyspark apache-airflow-providers-apache-spark apache-airflow-providers-cncf-kubernetes
USER root
